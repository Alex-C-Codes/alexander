    ...
    return (
        <div className="musicPage">
            <div className="content-card-container">
                <h2>Music</h2>
                <p>I upload two songs a month to my YouTube channel.</p>
                <p>Subscribe to stay up to date.</p>

                {/* <iframe title="cozy-loop-pack" frameborder="0" src="https://itch.io/embed/1577689" width="552" height="167"><a href="https://alexcook.itch.io/relaxing-pack">Relaxing &amp; Cozy Music Loop Pack by Alex Cook</a></iframe> */}

                {/* <div style={{marginTop:'80px'}}>
                    <a href="https://youtube.com/@alexfcook?feature=shared">YouTube</a>
                </div> */}
                ...
                {/* <ul>
                    <li><a href="https://www.youtube.com/channel/UCcZqftjivIchHJiuFULbl1g">YouTube</a></li>
                    <li><a href="https://alexcook.itch.io">itch.io</a></li>
                </ul> */}
            </div>
        </div>
    )
